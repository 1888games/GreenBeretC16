.namespace MAP {
	...
	* = * "Mapload"
	...
	Luminances: 
		...
		.byte LUMINANCE_7, LUMINANCE_7, LUMINANCE_7, LUMINANCE_6, LUMINANCE_6, LUMINANCE_5, LUMINANCE_3, LUMINANCE_0, LUMINANCE_2, LUMINANCE_4, LUMINANCE_4, LUMINANCE_4, LUMINANCE_3, LUMINANCE_0, LUMINANCE_7, LUMINANCE_7
