    ...
    .label ZP_Screen1_LSB = $10
    .label ZP_Screen1 = $10
    .label ZP_Screen1_MSB = $11
    .label ZP_ColourRam_LSB = $12
    .label ZP_ColourRam_MSB = $13
    .label ZP_ColourRam = $12
    ...
    .label SPACE_BAR = $05
    .label PLAYER_COLOUR =  LUMINANCE_1 + 5 + 8

    .label LivesLeft =  $040d
    .label PlayerY = $040a
...
* = $1001 "Base Address"  
        ...
        .byte $22,$10,$c3,$07,$9e,$34,$36,$32,$31  // BASIC upstart - 1987 SYS 4621 ($120D)

        .byte $20,$43,$52,$41,$43,$4b
        .byte $45,$44,$20,$42,$59,$20,$8f,$43 
        .byte $4f,$20,$48,$4f,$45,$56,$45,$52,$53,$00
        .byte $00,$00
    ...
    L_11c4:
        ...
        .byte $00,$ff,$00,$ff,$00,$ff,$00,$ff,$00,$ff,$00,$ff,$00,$ff,$00,$ff
        .byte $00,$ff,$00,$ff,$00,$ff,$00,$ff,$00,$ff,$00,$ff,$00,$ff,$00,$ff
        .byte $00,$ff,$00,$ff,$00,$ff,$00,$ff,$00

      
    // Is this ever called...?

        lda #$08        // Load accumulator with immediate value $08
        sta $ae         // Store accumulator to zero page address $ae
        ldx #$00        // Load X register with immediate value $00
        ldy #$30        // Load Y register with immediate value $30
        lda #$00        // Load accumulator with immediate value $00
        jsr $f043       // Jump to subroutine at address $f043

   EntryPoint:

    * = * "Entry"

        lda #$01        // Load accumulator with immediate value $01
        sta $2214       // Store accumulator to address $2214
        lda #$00        // Load accumulator with immediate value $00
        sta $2200       // Store accumulator to address $2200
        sta $2201       // Store accumulator to address $2201



        jmp $1b00       // Jump to address $1b00     

   // .byte $a9,$08,$85,$ae,$a2,$00,$a0
      //  .byte $30,$a9,$00,$20,$43,$f0,$a9,$01,$8d,$14,$22,$a9,$00,$8d,$00,$22
      //  .byte $8d,$01,$22,$4c,$00,$1b,$00
    ...
    L_1b70:
        lda #0
        sta ZP_Screen1_LSB
        sta ZP_ColourRam_LSB 

        lda #>COLOR_RAM
        sta ZP_ColourRam_MSB
    ...
    L_1cb0:
       // .byte $ea,$a0,$02,$b1,$21,$18,$69,$01,$91,$21,$c9,$27
    ...
    .byte $b0,$32
        ...
        .byte $4c,$4b,$1c,$60,$a9,$71,$81,$1f,$60
...
skip_block:
    ...
    * = * "Stab"
    ...
    StabText:
        ...
        .text @" STAB TO START\$00"

       // .byte $20,$20,$20,$20,$20,$20,$13,$14
        //.byte $01,$02,$20,$14,$0f,$20,$13,$14,$01,$12,$14,$00,
 ...
 RestoreBackground_Plyr:
    ...
    * = * "Charset"
    ...
    //     .byte $00,$00,$00,$00,$00,$00,$00,$00,$18,$3c,$66,$7e,$66,$66
